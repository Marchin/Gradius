...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/Osmo/OSMO1.oep", __ASSET__assets_osmo_osmo1_oep);
		type.set ("assets/Osmo/OSMO1.oep", AssetType.TEXT);
		className.set ("assets/Osmo/test.oel", __ASSET__assets_osmo_test_oel);
		type.set ("assets/Osmo/test.oel", AssetType.TEXT);
		className.set ("assets/Osmo/tiles.png", __ASSET__assets_osmo_tiles_png);
...
@:keep @:bind #if display private #end class __ASSET__assets_osmo_osmo1_oep extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_osmo_test_oel extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_osmo_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/Osmo/OSMO1.oep") #if display private #end class __ASSET__assets_osmo_osmo1_oep extends lime.utils.Bytes {}
@:file("assets/Osmo/test.oel") #if display private #end class __ASSET__assets_osmo_test_oel extends lime.utils.Bytes {}
@:image("assets/Osmo/tiles.png") #if display private #end class __ASSET__assets_osmo_tiles_png extends lime.graphics.Image {}
